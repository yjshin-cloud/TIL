...
graph TB
    subgraph "가상머신 방식 🐌"
        direction TB
        VM1[물리 컴퓨터<br/>💻 실제 컴퓨터]
        VM2[가상화 프로그램<br/>📦 VMware 같은거]
        VM3[가상 컴퓨터 1<br/>🖥️ Windows 전체 (2GB)]
        VM4[가상 컴퓨터 2<br/>🖥️ Linux 전체 (2GB)]
        VM5[내 프로그램 1<br/>📱 웹사이트]
        VM6[내 프로그램 2<br/>📱 게임]
    ...
    subgraph "Docker 방식 🚀"
        direction TB
        D1[물리 컴퓨터<br/>💻 실제 컴퓨터]
        D2[운영체제<br/>🖥️ Windows/Mac/Linux]
        D3[Docker<br/>🐳 컨테이너 관리자]
        D4[컨테이너 1<br/>📦 웹사이트만 (50MB)]
        D5[컨테이너 2<br/>📦 게임만 (100MB)]
    ...
    VM7[😰 무겁고 느림<br/>컴퓨터 통째로 복사] --> VM1
    D6[😊 가볍고 빠름<br/>필요한 것만 포함] --> D1
```
