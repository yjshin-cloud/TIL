<template><div><h1 id="javascript-dom-bom-완벽-가이드-📚" tabindex="-1"><a class="header-anchor" href="#javascript-dom-bom-완벽-가이드-📚"><span>JavaScript DOM &amp; BOM 완벽 가이드 📚</span></a></h1>
<h2 id="목차" tabindex="-1"><a class="header-anchor" href="#목차"><span>목차</span></a></h2>
<ol>
<li><a href="#1-dom%EA%B3%BC-bom-%EA%B0%9C%EB%85%90-%EC%9D%B4%ED%95%B4">DOM과 BOM 개념 이해</a></li>
<li><a href="#2-dom-%EA%B5%AC%EC%A1%B0%EC%99%80-%EC%9E%91%EB%8F%99-%EC%9B%90%EB%A6%AC">DOM 구조와 작동 원리</a></li>
<li><a href="#3-dom-%EC%A1%B0%EC%9E%91-%EC%8B%A4%EC%8A%B5">DOM 조작 실습</a></li>
<li><a href="#4-bom-%EA%B0%9C%EB%85%90%EA%B3%BC-%ED%99%9C%EC%9A%A9">BOM 개념과 활용</a></li>
</ol>
<hr>
<h2 id="_1-dom과-bom-개념-이해" tabindex="-1"><a class="header-anchor" href="#_1-dom과-bom-개념-이해"><span>1. DOM과 BOM 개념 이해</span></a></h2>
<h3 id="dom-document-object-model-이란-🌳" tabindex="-1"><a class="header-anchor" href="#dom-document-object-model-이란-🌳"><span>DOM (Document Object Model)이란? 🌳</span></a></h3>
<ul>
<li><strong>문서 객체 모델</strong>: HTML과 XML 문서를 프로그래밍 언어로 조작할 수 있게 해주는 인터페이스</li>
<li>웹 페이지의 <strong>구조화된 표현</strong>을 제공하여 JavaScript가 HTML 요소들을 찾고, 변경하고, 삭제할 수 있게 함</li>
<li>문서를 <strong>트리 구조</strong>로 표현하여 각 요소에 접근 가능</li>
</ul>
<h3 id="bom-browser-object-model-이란-🌐" tabindex="-1"><a class="header-anchor" href="#bom-browser-object-model-이란-🌐"><span>BOM (Browser Object Model)이란? 🌐</span></a></h3>
<ul>
<li><strong>브라우저 객체 모델</strong>: 브라우저의 창(window)과 관련된 객체들을 제어하는 모델</li>
<li>브라우저의 <strong>창, 탭, 주소창, 히스토리</strong> 등을 JavaScript로 제어</li>
<li>DOM과 달리 <strong>표준이 없어</strong> 브라우저마다 조금씩 다름</li>
</ul>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dom-vs-bom-주요-차이점" tabindex="-1"><a class="header-anchor" href="#dom-vs-bom-주요-차이점"><span>DOM vs BOM 주요 차이점</span></a></h3>
<table>
<thead>
<tr>
<th>구분</th>
...
<td>W3C 표준 존재</td>
<td>표준 없음 (브라우저마다 차이)</td>
</tr>
<tr>
<td><strong>주요 기능</strong></td>
<td>요소 추가/삭제/수정</td>
<td>새 창 열기, 주소 변경, 알림</td>
</tr>
</tbody>
</table>
<hr>
<h2 id="_2-dom-구조와-작동-원리" tabindex="-1"><a class="header-anchor" href="#_2-dom-구조와-작동-원리"><span>2. DOM 구조와 작동 원리</span></a></h2>
<h3 id="dom-트리-구조-🌲" tabindex="-1"><a class="header-anchor" href="#dom-트리-구조-🌲"><span>DOM 트리 구조 🌲</span></a></h3>
<div class="language-mermaid line-numbers-mode" data-highlighter="prismjs" data-ext="mermaid"><pre v-pre><code class="language-mermaid"><span class="line"><span class="token keyword">graph</span> TD</span>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">// 1. 요소 선택하기 (Finding Elements)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="_3-dom-조작-실습" tabindex="-1"><a class="header-anchor" href="#_3-dom-조작-실습"><span>3. DOM 조작 실습</span></a></h2>
<h3 id="동적-요소-추가-삭제-예제-분석" tabindex="-1"><a class="header-anchor" href="#동적-요소-추가-삭제-예제-분석"><span>동적 요소 추가/삭제 예제 분석</span></a></h3>
<p>다음은 실습 파일에서 가져온 핵심 코드입니다:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="_6-고급-활용-예제" tabindex="-1"><a class="header-anchor" href="#_6-고급-활용-예제"><span>6. 고급 활용 예제</span></a></h2>
<h3 id="실시간-시계-만들기-dom-bom-종합" tabindex="-1"><a class="header-anchor" href="#실시간-시계-만들기-dom-bom-종합"><span>실시간 시계 만들기 (DOM + BOM 종합)</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="_7-성능-최적화-팁" tabindex="-1"><a class="header-anchor" href="#_7-성능-최적화-팁"><span>7. 성능 최적화 팁</span></a></h2>
<h3 id="dom-조작-최적화" tabindex="-1"><a class="header-anchor" href="#dom-조작-최적화"><span>DOM 조작 최적화</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">/*</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="이벤트-위임-event-delegation" tabindex="-1"><a class="header-anchor" href="#이벤트-위임-event-delegation"><span>이벤트 위임 (Event Delegation)</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">/*</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="_8-디버깅과-문제-해결" tabindex="-1"><a class="header-anchor" href="#_8-디버깅과-문제-해결"><span>8. 디버깅과 문제 해결</span></a></h2>
<h3 id="자주-발생하는-오류들" tabindex="-1"><a class="header-anchor" href="#자주-발생하는-오류들"><span>자주 발생하는 오류들</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">/*</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="_9-마무리-및-추가-학습-자료" tabindex="-1"><a class="header-anchor" href="#_9-마무리-및-추가-학습-자료"><span>9. 마무리 및 추가 학습 자료</span></a></h2>
<h3 id="핵심-요약" tabindex="-1"><a class="header-anchor" href="#핵심-요약"><span>핵심 요약</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="다음-단계-학습-주제" tabindex="-1"><a class="header-anchor" href="#다음-단계-학습-주제"><span>다음 단계 학습 주제</span></a></h3>
<ol>
<li>
<p><strong>ES6+ 문법과 DOM</strong></p>
<ul>
<li>Arrow Functions와 이벤트 처리</li>
<li>Template Literals와 HTML 생성</li>
<li>Destructuring과 요소 속성 관리</li>
</ul>
</li>
<li>
<p><strong>고급 DOM 조작</strong></p>
<ul>
<li>Shadow DOM</li>
...
<li>
<p><strong>비동기 프로그래밍과 DOM</strong></p>
<ul>
<li>Fetch API와 동적 콘텐츠 로딩</li>
<li>Promise/async-await와 DOM 조작</li>
<li>무한 스크롤, 지연 로딩</li>
</ul>
</li>
<li>
...
<ul>
<li>Virtual DOM 개념</li>
<li>Intersection Observer API</li>
<li>메모리 프로파일링</li>
</ul>
</li>
</ol>
<h3 id="연습-문제" tabindex="-1"><a class="header-anchor" href="#연습-문제"><span>연습 문제</span></a></h3>
<ol>
<li><strong>초급</strong>: 간단한 할 일 목록 만들기</li>
<li><strong>중급</strong>: 드래그 앤 드롭으로 순서 변경 가능한 목록</li>
<li><strong>고급</strong>: 무한 스크롤이 있는 이미지 갤러리</li>
<li><strong>심화</strong>: 단일 페이지 애플리케이션(SPA) 라우터 구현</li>
</ol>
<h3 id="유용한-참고-자료" tabindex="-1"><a class="header-anchor" href="#유용한-참고-자료"><span>유용한 참고 자료</span></a></h3>
<ul>
<li><a href="https://developer.mozilla.org/ko/docs/Web/API/Document_Object_Model" target="_blank" rel="noopener noreferrer">MDN Web Docs - DOM</a></li>
<li><a href="https://developer.mozilla.org/ko/docs/Web/API/Window" target="_blank" rel="noopener noreferrer">MDN Web Docs - BOM</a></li>
<li><a href="https://ko.javascript.info/dom-nodes" target="_blank" rel="noopener noreferrer">JavaScript.info - DOM 조작</a></li>
<li><a href="https://www.w3.org/WAI/WCAG21/quickref/" target="_blank" rel="noopener noreferrer">웹 접근성 가이드라인</a></li>
</ul>
<hr>
<blockquote>
<p>💡 <strong>학습 팁</strong>: DOM과 BOM은 실습을 통해 익히는 것이 가장 효과적입니다. 작은 프로젝트부터 시작하여 점진적으로 복잡한 기능을 추가해보세요!</p>
</blockquote>
<hr>
<p><em>이 가이드는 2025년 8월 25일 기준으로 작성되었습니다.
웹 표준은 지속적으로 발전하므로 최신 정보는 공식 문서를 참조하시기 바랍니다.</em> 버튼</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">const removeFirstBtn = document.getElementById('remove-first-btn'); // 첫 아이템 삭제 버튼</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dom-조작-과정-시각화" tabindex="-1"><a class="header-anchor" href="#dom-조작-과정-시각화"><span>DOM 조작 과정 시각화</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="_4-bom-개념과-활용" tabindex="-1"><a class="header-anchor" href="#_4-bom-개념과-활용"><span>4. BOM 개념과 활용</span></a></h2>
<h3 id="bom의-주요-객체들" tabindex="-1"><a class="header-anchor" href="#bom의-주요-객체들"><span>BOM의 주요 객체들</span></a></h3>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">// 1. window 객체 - 브라우저 창 제어</span></span>
