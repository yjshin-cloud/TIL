<template><div><h1 id="go-언어-함수-완전-정복-가이드-🚀" tabindex="-1"><a class="header-anchor" href="#go-언어-함수-완전-정복-가이드-🚀"><span>Go 언어 함수 완전 정복 가이드 🚀</span></a></h1>
<blockquote>
<p>Go Functions Part One 강의 내용 정리</p>
</blockquote>
<h2 id="📊-go-언어의-기본-타입-시스템" tabindex="-1"><a class="header-anchor" href="#📊-go-언어의-기본-타입-시스템"><span>📊 Go 언어의 기본 타입 시스템</span></a></h2>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="주요-데이터-타입" tabindex="-1"><a class="header-anchor" href="#주요-데이터-타입"><span>주요 데이터 타입</span></a></h3>
<ul>
<li><strong>String</strong>: 문자열 데이터</li>
<li><strong>Boolean</strong>: true/false 값</li>
<li><strong>int</strong>: 정수 (기본적으로 사용)</li>
<li><strong>int8, int16, int32, int64</strong>: 다양한 크기의 정수</li>
<li><strong>uint</strong>: 부호 없는 정수</li>
<li><strong>Array &amp; Slices</strong>: 배열과 슬라이스</li>
</ul>
<blockquote>
<p>💡 <strong>초보자 팁</strong>: Computer Science 배경지식이 없어도 걱정하지 마세요! 기본적으로는 String, Boolean, int만 알면 시작할 수 있습니다.</p>
</blockquote>
<h2 id="🔧-go-함수의-기본-구조" tabindex="-1"><a class="header-anchor" href="#🔧-go-함수의-기본-구조"><span>🔧 Go 함수의 기본 구조</span></a></h2>
<h3 id="_1-기본-함수-선언" tabindex="-1"><a class="header-anchor" href="#_1-기본-함수-선언"><span>1. 기본 함수 선언</span></a></h3>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go"><pre v-pre><code class="language-go"><span class="line"><span class="token comment">// 잘못된 예시 (타입 미지정)</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-함수-선언-규칙" tabindex="-1"><a class="header-anchor" href="#_2-함수-선언-규칙"><span>2. 함수 선언 규칙</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Go 함수의 특징:</strong></p>
<ul>
<li>매개변수의 타입을 <strong>반드시</strong> 명시해야 함</li>
<li>반환값의 타입도 <strong>반드시</strong> 명시해야 함</li>
<li>컴파일러가 타입을 체크해서 안전성 보장</li>
</ul>
<h2 id="🎯-go만의-특별한-기능-다중-반환값" tabindex="-1"><a class="header-anchor" href="#🎯-go만의-특별한-기능-다중-반환값"><span>🎯 Go만의 특별한 기능: 다중 반환값</span></a></h2>
<h3 id="다중-반환값-함수-예시" tabindex="-1"><a class="header-anchor" href="#다중-반환값-함수-예시"><span>다중 반환값 함수 예시</span></a></h3>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go"><pre v-pre><code class="language-go"><span class="line"><span class="token comment">// 문자열의 길이와 대문자 변환을 동시에 반환</span></span>
...
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go"><pre v-pre><code class="language-go"><span class="line"><span class="token comment">// 하나의 값만 필요할 때</span></span>
...
<span class="line">fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span>upperName<span class="token punctuation">)</span>   <span class="token comment">// 출력: NICO</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-mermaid line-numbers-mode" data-highlighter="prismjs" data-ext="mermaid"><pre v-pre><code class="language-mermaid"><span class="line"><span class="token keyword">graph</span> TD</span>
...
<h3 id="무제한-매개변수-받기" tabindex="-1"><a class="header-anchor" href="#무제한-매개변수-받기"><span>무제한 매개변수 받기</span></a></h3>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go"><pre v-pre><code class="language-go"><span class="line"><span class="token comment">// 여러 개의 문자열을 받는 함수</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>가변 인자 함수의 특징:</strong></p>
<ul>
<li>타입 앞에 <code v-pre>...</code> 을 붙여서 선언</li>
<li>내부적으로 slice로 처리됨</li>
<li>원하는 만큼 인자를 전달할 수 있음</li>
</ul>
<h2 id="📦-go-표준-라이브러리의-강력함" tabindex="-1"><a class="header-anchor" href="#📦-go-표준-라이브러리의-강력함"><span>📦 Go 표준 라이브러리의 강력함</span></a></h2>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Go 표준 라이브러리 살펴보기:</strong></p>
<ul>
<li><a href="https://golang.org/pkg/" target="_blank" rel="noopener noreferrer">Go 공식 패키지 문서</a></li>
<li>데이터베이스, 암호화, 이미지 처리, 네트워킹 등 모든 것 포함</li>
<li>별도 설치 없이 바로 사용 가능</li>
</ul>
<h2 id="🎓-학습-포인트-정리" tabindex="-1"><a class="header-anchor" href="#🎓-학습-포인트-정리"><span>🎓 학습 포인트 정리</span></a></h2>
<h3 id="_1-함수-정의-단계별-가이드" tabindex="-1"><a class="header-anchor" href="#_1-함수-정의-단계별-가이드"><span>1. 함수 정의 단계별 가이드</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-go-함수의-핵심-규칙" tabindex="-1"><a class="header-anchor" href="#_2-go-함수의-핵심-규칙"><span>2. Go 함수의 핵심 규칙</span></a></h3>
<table>
<thead>
<tr>
<th>규칙</th>
...
<tr>
<td>타입 명시 필수</td>
<td>모든 매개변수와 반환값의 타입을 반드시 지정</td>
<td><code v-pre>func add(a, b int) int</code></td>
</tr>
<tr>
<td>다중 반환 가능</td>
<td>여러 개의 값을 동시에 반환할 수 있음</td>
<td><code v-pre>func getData() (int, string)</code></td>
</tr>
<tr>
<td>가변 인자 지원</td>
<td>개수가 정해지지 않은 매개변수 처리 가능</td>
<td><code v-pre>func print(args ...string)</code></td>
</tr>
<tr>
<td>미사용 변수 금지</td>
<td>선언하고 사용하지 않으면 컴파일 에러</td>
<td><code v-pre>_</code>로 무시 처리</td>
</tr>
</tbody>
</table>
<h3 id="_3-일반적인-실수와-해결법" tabindex="-1"><a class="header-anchor" href="#_3-일반적인-실수와-해결법"><span>3. 일반적인 실수와 해결법</span></a></h3>
<h4 id="❌-흔한-실수들" tabindex="-1"><a class="header-anchor" href="#❌-흔한-실수들"><span>❌ 흔한 실수들</span></a></h4>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go"><pre v-pre><code class="language-go"><span class="line"><span class="token comment">// 1. 타입 미지정</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="✅-올바른-해결법" tabindex="-1"><a class="header-anchor" href="#✅-올바른-해결법"><span>✅ 올바른 해결법</span></a></h4>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go"><pre v-pre><code class="language-go"><span class="line"><span class="token comment">// 1. 타입 명시</span></span>
<span class="line"><span class="token keyword">func</span> <span class="token function">multiply</span><span class="token punctuation">(</span>a<span class="token punctuation">,</span> b <span class="token builtin">int</span><span class="token punctuation">)</span> <span class="token builtin">int</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token keyword">return</span> a <span class="token operator">*</span> b</span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🚀-실습-예제" tabindex="-1"><a class="header-anchor" href="#🚀-실습-예제"><span>🚀 실습 예제</span></a></h2>
<h3 id="기본-함수-연습" tabindex="-1"><a class="header-anchor" href="#기본-함수-연습"><span>기본 함수 연습</span></a></h3>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="💡-추가-학습-가이드" tabindex="-1"><a class="header-anchor" href="#💡-추가-학습-가이드"><span>💡 추가 학습 가이드</span></a></h2>
<h3 id="다음-단계-학습-내용" tabindex="-1"><a class="header-anchor" href="#다음-단계-학습-내용"><span>다음 단계 학습 내용</span></a></h3>
<ul>
<li>함수형 프로그래밍 개념</li>
...
<h3 id="권장-연습-문제" tabindex="-1"><a class="header-anchor" href="#권장-연습-문제"><span>권장 연습 문제</span></a></h3>
<ol>
<li>팩토리얼 계산 함수 만들기</li>
<li>피보나치 수열 생성 함수 만들기</li>
<li>문자열 처리 유틸리티 함수 모음 만들기</li>
<li>계산기 함수 모음 만들기</li>
</ol>
<hr>
<p><strong>핵심 메시지:</strong></p>
<ul>
<li>Go는 타입을 명확히 지정해야 하는 <strong>강타입 언어</strong></li>
<li><strong>다중 반환값</strong>은 Go만의 독특한 장점</li>
<li><strong>표준 라이브러리</strong>가 매우 풍부함</li>
<li><strong>가변 인자 함수</strong>로 유연한 함수 작성 가능</li>
</ul>
<blockquote>
<p>🎯 <strong>Next Step</strong>: 함수 Part Two에서는 더 고급 함수 개념들을 다룰 예정입니다!</p>
</blockquote>
</div></template>
