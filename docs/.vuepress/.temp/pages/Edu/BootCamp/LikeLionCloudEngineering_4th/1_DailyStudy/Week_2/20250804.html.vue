<template><div><h1 id="java-객체지향-프로그래밍-완전-정복-가이드-☕" tabindex="-1"><a class="header-anchor" href="#java-객체지향-프로그래밍-완전-정복-가이드-☕"><span>Java 객체지향 프로그래밍 완전 정복 가이드 ☕</span></a></h1>
<blockquote>
<p>멋쟁이 사자처럼 5일차 강의 정리 (2025.08.04)</p>
</blockquote>
<h2 id="🎯-객체지향-프로그래밍이란" tabindex="-1"><a class="header-anchor" href="#🎯-객체지향-프로그래밍이란"><span>🎯 객체지향 프로그래밍이란?</span></a></h2>
<p>객체지향 프로그래밍(OOP)은 <strong>현실 세계의 사물</strong>을 프로그램에서 <strong>객체</strong>로 모델링하는 프로그래밍 패러다임입니다.</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="📊-java-oop-클래스-계층-구조" tabindex="-1"><a class="header-anchor" href="#📊-java-oop-클래스-계층-구조"><span>📊 Java OOP 클래스 계층 구조</span></a></h2>
<h3 id="ai-챗봇-프로젝트를-통한-oop-이해" tabindex="-1"><a class="header-anchor" href="#ai-챗봇-프로젝트를-통한-oop-이해"><span>AI 챗봇 프로젝트를 통한 OOP 이해</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🏗-인터페이스-interface" tabindex="-1"><a class="header-anchor" href="#🏗-인터페이스-interface"><span>🏗 인터페이스 (Interface)</span></a></h2>
<h3 id="igemini-인터페이스-설계" tabindex="-1"><a class="header-anchor" href="#igemini-인터페이스-설계"><span>IGemini 인터페이스 설계</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">IGemini</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>인터페이스의 특징:</strong></p>
<ul>
<li>모든 메서드는 기본적으로 <code v-pre>public abstract</code></li>
<li>구현체에서 반드시 구현해야 함</li>
<li>다중 상속이 가능함</li>
<li><strong>계약(Contract)</strong> 역할을 함</li>
</ul>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🎨-추상-클래스-abstract-class" tabindex="-1"><a class="header-anchor" href="#🎨-추상-클래스-abstract-class"><span>🎨 추상 클래스 (Abstract Class)</span></a></h2>
<h3 id="chatbot-추상-클래스-분석" tabindex="-1"><a class="header-anchor" href="#chatbot-추상-클래스-분석"><span>Chatbot 추상 클래스 분석</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Chatbot</span> <span class="token keyword">implements</span> <span class="token class-name">IGemini</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>추상 클래스 vs 인터페이스:</strong></p>
<table>
<thead>
<tr>
<th>구분</th>
...
<tr>
<td>메서드</td>
<td>구현된 메서드 + 추상 메서드</td>
<td>기본적으로 추상 메서드</td>
</tr>
<tr>
<td>필드</td>
<td>인스턴스 변수 가능</td>
<td>static final만 가능</td>
</tr>
<tr>
<td>생성자</td>
<td>가능</td>
...
<h2 id="🔄-템플릿-메서드-패턴" tabindex="-1"><a class="header-anchor" href="#🔄-템플릿-메서드-패턴"><span>🔄 템플릿 메서드 패턴</span></a></h2>
<p>Chatbot 클래스의 <code v-pre>chat</code> 메서드는 <strong>템플릿 메서드 패턴</strong>을 사용합니다:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="👶-구체-클래스-concrete-class" tabindex="-1"><a class="header-anchor" href="#👶-구체-클래스-concrete-class"><span>👶 구체 클래스 (Concrete Class)</span></a></h2>
<h3 id="rolechatbot-클래스-구현" tabindex="-1"><a class="header-anchor" href="#rolechatbot-클래스-구현"><span>RoleChatbot 클래스 구현</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RoleChatbot</span> <span class="token keyword">extends</span> <span class="token class-name">Chatbot</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🌐-http-통신과-api-연동" tabindex="-1"><a class="header-anchor" href="#🌐-http-통신과-api-연동"><span>🌐 HTTP 통신과 API 연동</span></a></h2>
<h3 id="gemini-api-연동-구조" tabindex="-1"><a class="header-anchor" href="#gemini-api-연동-구조"><span>Gemini API 연동 구조</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="http-요청-처리-코드-분석" tabindex="-1"><a class="header-anchor" href="#http-요청-처리-코드-분석"><span>HTTP 요청 처리 코드 분석</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token comment">// 1. 메시지를 JSON 형태로 변환</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🎮-실제-사용-예제" tabindex="-1"><a class="header-anchor" href="#🎮-실제-사용-예제"><span>🎮 실제 사용 예제</span></a></h2>
<h3 id="geminiver3-메인-클래스" tabindex="-1"><a class="header-anchor" href="#geminiver3-메인-클래스"><span>GeminiVer3 메인 클래스</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GeminiVer3</span> <span class="token punctuation">{</span></span>
...
<h3 id="추천-ai-개발-도구들" tabindex="-1"><a class="header-anchor" href="#추천-ai-개발-도구들"><span>추천 AI 개발 도구들</span></a></h3>
<div class="language-mermaid line-numbers-mode" data-highlighter="prismjs" data-ext="mermaid"><pre v-pre><code class="language-mermaid"><span class="line"><span class="token keyword">graph</span> TD</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="추가-api-서비스들" tabindex="-1"><a class="header-anchor" href="#추가-api-서비스들"><span>추가 API 서비스들</span></a></h3>
<ul>
<li><strong><a href="https://api.together.ai/" target="_blank" rel="noopener noreferrer">Together AI</a></strong>: 다양한 오픈소스 모델</li>
<li><strong><a href="https://groq.com/" target="_blank" rel="noopener noreferrer">Groq</a></strong>: 초고속 추론 서비스</li>
<li><strong><a href="https://openrouter.ai/models?q=free" target="_blank" rel="noopener noreferrer">OpenRouter</a></strong>: 무료 모델 제공</li>
</ul>
<h2 id="🎓-oop-설계-원칙-solid" tabindex="-1"><a class="header-anchor" href="#🎓-oop-설계-원칙-solid"><span>🎓 OOP 설계 원칙 (SOLID)</span></a></h2>
<div class="language-mermaid line-numbers-mode" data-highlighter="prismjs" data-ext="mermaid"><pre v-pre><code class="language-mermaid"><span class="line"><span class="token keyword">graph</span> TD</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🔍-예외-처리와-에러-핸들링" tabindex="-1"><a class="header-anchor" href="#🔍-예외-처리와-에러-핸들링"><span>🔍 예외 처리와 에러 핸들링</span></a></h2>
<h3 id="throws-vs-try-catch-패턴" tabindex="-1"><a class="header-anchor" href="#throws-vs-try-catch-패턴"><span>throws vs try-catch 패턴</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token comment">// 1. throws로 예외 전파</span></span>
<span class="line"><span class="token keyword">public</span> <span class="token class-name">String</span> <span class="token function">chat</span><span class="token punctuation">(</span><span class="token class-name">String</span> message<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>예외 처리 전략:</strong></p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🚀-실습-프로젝트-확장-아이디어" tabindex="-1"><a class="header-anchor" href="#🚀-실습-프로젝트-확장-아이디어"><span>🚀 실습 프로젝트 확장 아이디어</span></a></h2>
<h3 id="_1-다양한-챗봇-타입-구현" tabindex="-1"><a class="header-anchor" href="#_1-다양한-챗봇-타입-구현"><span>1. 다양한 챗봇 타입 구현</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token comment">// 번역 전문 챗봇</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-챗봇-팩토리-패턴" tabindex="-1"><a class="header-anchor" href="#_2-챗봇-팩토리-패턴"><span>2. 챗봇 팩토리 패턴</span></a></h3>
<div class="language-mermaid line-numbers-mode" data-highlighter="prismjs" data-ext="mermaid"><pre v-pre><code class="language-mermaid"><span class="line"><span class="token keyword">classDiagram</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-대화-히스토리-관리" tabindex="-1"><a class="header-anchor" href="#_3-대화-히스토리-관리"><span>3. 대화 히스토리 관리</span></a></h3>
<div class="language-java line-numbers-mode" data-highlighter="prismjs" data-ext="java"><pre v-pre><code class="language-java"><span class="line"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ConversationManager</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="📚-학습-리소스-및-다음-단계" tabindex="-1"><a class="header-anchor" href="#📚-학습-리소스-및-다음-단계"><span>📚 학습 리소스 및 다음 단계</span></a></h2>
<h3 id="추천-학습-자료" tabindex="-1"><a class="header-anchor" href="#추천-학습-자료"><span>추천 학습 자료</span></a></h3>
<ul>
<li><strong><a href="https://docs.oracle.com/javase/" target="_blank" rel="noopener noreferrer">Java 공식 문서</a></strong>: 기본 개념 정리</li>
<li><strong><a href="https://www.oreilly.com/library/view/effective-java/9780134686097/" target="_blank" rel="noopener noreferrer">Effective Java</a></strong>: 고급 Java 기법</li>
<li><strong><a href="https://refactoring.guru/design-patterns" target="_blank" rel="noopener noreferrer">Design Patterns</a></strong>: 디자인 패턴 학습</li>
</ul>
<h3 id="다음-학습-단계" tabindex="-1"><a class="header-anchor" href="#다음-학습-단계"><span>다음 학습 단계</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="💡-핵심-포인트-요약" tabindex="-1"><a class="header-anchor" href="#💡-핵심-포인트-요약"><span>💡 핵심 포인트 요약</span></a></h2>
<h3 id="oop의-4대-원칙-실습-예제에서-확인" tabindex="-1"><a class="header-anchor" href="#oop의-4대-원칙-실습-예제에서-확인"><span>OOP의 4대 원칙 실습 예제에서 확인</span></a></h3>
<ol>
<li><strong>📦 캡슐화</strong>: <code v-pre>private</code> 필드와 <code v-pre>public</code> 메서드로 데이터 은닉</li>
<li><strong>🔗 상속</strong>: <code v-pre>Chatbot</code> → <code v-pre>RoleChatbot</code> 계층 구조</li>
<li><strong>🎭 다형성</strong>: 인터페이스를 통한 다양한 구현체 지원</li>
<li><strong>🎨 추상화</strong>: 복잡한 API 통신을 간단한 <code v-pre>chat()</code> 메서드로 제공</li>
</ol>
<h3 id="실무에서-중요한-개념들" tabindex="-1"><a class="header-anchor" href="#실무에서-중요한-개념들"><span>실무에서 중요한 개념들</span></a></h3>
<div class="language-mermaid line-numbers-mode" data-highlighter="prismjs" data-ext="mermaid"><pre v-pre><code class="language-mermaid"><span class="line">mindmap</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<p><strong>Remember</strong>: 객체지향 프로그래밍은 단순히 문법을 아는 것이 아니라, <strong>현실 세계의 문제를 객체 간의 협력</strong>으로 해결하는 사고방식입니다.</p>
<p><em>&quot;좋은 설계는 변경에 유연하고, 확장 가능하며, 이해하기 쉬운 코드를 만듭니다!&quot;</em> ✨</p>
</div></template>
